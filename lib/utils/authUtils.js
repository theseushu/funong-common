...
exports.isUserOfficial = exports.createShopAuthorized = exports.isUserExpertVerified = exports.isUserCompanyVerified = exports.isUserIDVerified = undefined;
...
var isUserOfficial = exports.isUserOfficial = function isUserOfficial(user) {
  if (!user) {
    return false;
  }
  return !!(0, _find3.default)(user.badges, function (badge) {
    return badge === _appConstants.badges.official.value;
  });
};