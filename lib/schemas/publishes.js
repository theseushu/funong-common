...
exports.default = function (AV) {
  ...
  var SupplyProduct = AV.Object.extends('SupplyProduct');
  var TripProduct = AV.Object.extends('TripProduct');
  var ShopProduct = AV.Object.extends('ShopProduct');
  var LogisticsProduct = AV.Object.extends('LogisticsProduct');
  var Inquiry = AV.Object.extends('Inquiry');
  var FlashSale = AV.Object.extends('FlashSale');
